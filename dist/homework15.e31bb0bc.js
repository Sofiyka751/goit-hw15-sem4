...
var searchCountries = (0, _lodash.default)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var query, response, countries, list, c, html;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 4:
        _context.prev = 4;
        _context.next = 7;
        return fetch("https://restcountries.com/v2/name/".concat(query));
      case 7:
      ...
      case 12:
        ...
        if (countries.length > 10) {
          (0, _core.info)({
            text: 'Забагато результатів. Уточніть запит.'
          });
          ...
          c = countries[0];
          html = "\n        <div class=\"country\">\n          <h2>".concat(c.name, "</h2>\n          <p><strong>\u0421\u0442\u043E\u043B\u0438\u0446\u044F:</strong> ").concat(c.capital, "</p>\n          <p><strong>\u041D\u0430\u0441\u0435\u043B\u0435\u043D\u043D\u044F:</strong> ").concat(c.population.toLocaleString(), "</p>\n          <p><strong>\u041C\u043E\u0432\u0438:</strong> ").concat(c.languages.map(function (l) {
            return l.name;
          }).join(', '), "</p>\n          <img class=\"flag\" src=\"").concat(c.flag, "\" alt=\"\u041F\u0440\u0430\u043F\u043E\u0440 ").concat(c.name, "\" style=\"width: 100px; margin-top: 10px;\" />\n        </div>");
...
//# sourceMappingURL=/homework15.e31bb0bc.js.map